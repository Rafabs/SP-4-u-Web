...
const roadmapData: Roadmap = {
  roadmap: [
    {
      ...
      itens: [
        ...
        { label: "Exibir todos os mapas unificados em Expore", checked: false },
        { label: "Corrigir exibição de dados de Pesquisa Origem e Destino (Exibição de 1997 e 2007)", checked: false },
        { label: "Corrigir AQI para dados de qualidade do ar em -- exibir na cor cinza", checked: false },
    ...
    },
    {
      ...
      itens: [
        { label: "Atualizar README.md", checked: false },
      ],
    },
    {
    ...
    },
    {
      ...
      itens: [
        ...
        { label: "Melhorias na interface e funcionalidade dos mapas", checked: false },
  ...
  historico: [
    ...
    { data: "22/02/2026", versao: "v26.02.6",  descricao: "Corrigir e implementar renderização progressiva ou virtual scroll em sptrans e artesp" },
